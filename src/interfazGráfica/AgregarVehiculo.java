...
public class AgregarVehiculo extends javax.swing.JFrame {
    ...
    public AgregarVehiculo(Concesionaria c, Pantalla1 pantalla) {
    this.c = c;
    ...
    private void initComponents() {
        ...
        txtPatente.setFont(new java.awt.Font("Microsoft JhengHei", 1, 14)); // NOI18N
        ...
        txtPrecio.setFont(new java.awt.Font("Microsoft JhengHei", 1, 14)); // NOI18N
        txtPrecio.setForeground(new java.awt.Color(255, 255, 255));
        txtPrecio.setBorder(null);

        txtAño.setBackground(new java.awt.Color(51, 51, 51));
        txtAño.setFont(new java.awt.Font("Microsoft JhengHei", 1, 14)); // NOI18N
